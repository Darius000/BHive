...
namespace BHive
{
	...
	public:
		Texture2D();
		Texture2D(const FString& fileName, const FString& directory, ETextureType InType, bool gamma = false, EWrapping wrapping = EWrapping::REPEAT, EMipMap mipmap = EMipMap::LINEAR, EFilter filter = EFilter::LINEAR, glm::vec3 borderColor = glm::vec3(1.0f));
